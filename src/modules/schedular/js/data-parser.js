...
function sommaWorloadTaskInMatrice(objGlobale, objLocale, richiesteAnalizzate, idRisorsa) {
    /**
     * Bug:
     * ObjGlobale e objLocale contengono lo stesso numero di valori ma con numerro di settimana diversa
     * Es:
     * globale contiene i dati della WK10, aggiunti dai task precedenti
     * locale contiene i dati della WK11, dati del task.
     * La ricerca viene fatta per ogni chiave del oggetto globale [WK10]
     * In questo caso il carico locale è undefined, perchè serve key WK11
     */
