...
// import "../libs/schedular/dhtmlxscheduler_daytimeline";
// import "../libs/schedular/dhtmlxscheduler_readonly";
export const myScheduler = scheduler; //wrapper per la libreria
