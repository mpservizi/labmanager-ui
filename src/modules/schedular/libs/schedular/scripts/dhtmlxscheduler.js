...
!(function() {
  ...
  window.dhtmlx ||
        ...
        ((window[t] = function(t) {
          ...
          if (t && 'object' == typeof t && !t.tagName) {
            ...
            for (var n in t)
              e[n]
                ? this[e[n]](t[n])
                : 0 === n.indexOf('on') && this.attachEvent(n, t[n]);
    ...
    (dtmlXMLLoaderObject.prototype.getXMLTopNode = function(t, e) {
      ...
      if (this.xmlDoc.responseXML) {
        ...
        if (0 === a.length && -1 != t.indexOf(':'))
          var a = this.xmlDoc.responseXML.getElementsByTagName(t.split(':')[1]);
        i = a[0];
    ...
    (dtmlXMLLoaderObject.prototype.xmlNodeToJSON = function(t) {
      ...
      for (var i = 0; i < t.childNodes.length; i++) {
        ...
        a &&
          (e[a] || (e[a] = []), e[a].push(this.xmlNodeToJSON(t.childNodes[i])));
      }
      return e;
    }),
      ...
      if (!(new Date().valueOf() - e.downtime < 100)) {
        ...
        if (e.dragNode.parentNode != window.document.body && e.gldragNode) {
          ...
          if (
            ...
            (n.innerHTML = e.dragNode.outerHTML),
              (e.dragNode = n.childNodes[0]);
          } else e.dragNode = e.dragNode.cloneNode(!0);
          (e.dragNode.pWindow = window),
            (e.gldragNode.old = e.dragNode),
            document.body.appendChild(e.dragNode),
            (a.dhtmlDragAndDrop.dragNode = e.dragNode);
        }
    ...
    (dhtmlDragAndDropObject.prototype.calculateFramePosition = function(t) {
      if (window.name) {
        for (
          ...
          (i += e.offsetLeft), (a += e.offsetTop), (e = e.offsetParent);
  ...
  -1 != navigator.userAgent.indexOf('Macintosh') && (_isMacOS = !0),
    ...
    (dtmlXMLLoaderObject.prototype.doXPathOpera = function(t, e) {
      ...
      if ('.' == i[0]) a = [e];
        ...
        if ('' !== i[0]) return [];
        (a = (this.xmlDoc.responseXML || this.xmlDoc).getElementsByTagName(
          i[n].replace(/\[[^\]]*\]/g, '')
        )),
          n++;
      }
      ...
      return (
        -1 != i[n - 1].indexOf('[') && (a = this._filterXPath(a, i[n - 1])), a
      );
    }),
    (dtmlXMLLoaderObject.prototype._filterXPath = function(t, e) {
      for (
        ...
        t[a].getAttribute(e) && (i[i.length] = t[a]);
      return i;
    }),
    (dtmlXMLLoaderObject.prototype._getAllNamedChilds = function(t, e) {
      ...
      for (var a = 0; a < t.length; a++)
        for (var n = 0; n < t[a].childNodes.length; n++)
          _isKHTML
            ? t[a].childNodes[n].tagName &&
              t[a].childNodes[n].tagName.toUpperCase() == e &&
              (i[i.length] = t[a].childNodes[n])
            : t[a].childNodes[n].tagName == e &&
              (i[i.length] = t[a].childNodes[n]);
      return i;
    }),
    ...
    (function() {
        ...
        if (c) {
          ...
          if (dhtmlx.message.keyboard) {
            if (13 == i || 32 == i) {
              ...
              scheduler._getClassName(n).indexOf('dhtmlx_popup_button') > -1 &&
              n.click
                ? n.click()
                : (t(c, !0), (a = !0));
            }
      ...
      function h(t, e, i, a) {
        return (
          'object' != typeof t && (t = { text: t, type: e, expire: i, id: a }),
          (t.id = t.id || u.uid()),
  ...
  (dataProcessor.prototype = {
    setTransactionMode: function(t, e) {
      ...
      'JSON' == this._tMode &&
        ...
        (this._headers[a] = 'application/json')),
        this._headers &&
          !i(this._headers, a) &&
          (this._headers[a] = 'application/x-www-form-urlencoded');
    },
    escape: function(t) {
    ...
    markRow: function(t, e, i) {
      var a = '',
        n = this.is_invalid(t);
      if (
        (n && ((a = this.styles[n]), (e = !0)),
        this.callEvent('onRowMark', [t, e, i, n]) &&
          ((a = this.styles[e ? i : 'clear'] + a),
          this.obj[this._methods[0]](t, a),
          n && n.details))
      ) {
        a += this.styles[n + '_cell'];
        for (var r = 0; r < n.details.length; r++)
          n.details[r] && this.obj[this._methods[1]](t, r, a);
      }
    },
    getState: function(t) {
    ...
    serialize: function(t, e) {
      ...
      for (var n in t)
        t.hasOwnProperty(n) &&
          (i.push(this.serialize_one(t[n], n + this.post_delim)), a.push(n));
      return (
        i.push('ids=' + this.escape(a.join(','))),
      ...
      if (t) {
        ...
        var i = this,
          ...
          r =
            ...
            (this._user
              ? n.urlSeparator(this.serverProcessor) +
                [
                  'dhx_user=' + this._user,
    ...
    _getAllData: function(t) {
      for (var e = {}, i = !1, a = 0; a < this.updatedRows.length; a++) {
        ...
        if (!this._in_progress[n] && !this.is_invalid(n)) {
          ...
          this.callEvent('onBeforeUpdate', [n, this.getState(n), r]) &&
            ((e[n] = r),
            (i = !0),
    ...
    afterUpdateCallback: function(t, e, i, a) {
      ...
      if (
        ...
        this._uActions && this._uActions[i] && !this._uActions[i](a))
      )
      ...
      switch (i) {
        ...
        case 'deleted':
          return (
            ...
            delete this._in_progress[n],
            this.callEvent('onAfterUpdate', [t, i, e, a])
          );
      }
      'wait' != this._in_progress[n]
    ...
    (Scheduler.getSchedulerInstance = function() {
      ...
      function i(t) {
        ...
        if (i) {
          ...
          if (
            (t.click && a.addEventListener('click', t.click),
            t.html && (a.innerHTML = t.html),
            t.align)
          ) {
            var n = '';
            'right' == t.align
              ? (n = 'flex-end')
              : 'left' == t.align && (n = 'flex-start'),
              ...
              clearTimeout(r),
                (r = setTimeout(function() {
                  if (t(a.$container)) {
                    ...
                    i(s, r) ||
                      ((s = r),
                      a.callEvent('onSchedulerResize', []) &&
                        (a.updateView(),
                        a.callEvent('onAfterSchedulerResize', [])));
                  }
                }, 150));
            });
          }
      ...
      (g.init = function(t, e, i) {
        ...
        (g.set_sizes = function() {
          ...
          g._is_material_skin()
            ? (n ||
                ...
                (n.className = 'dhx_cal_scale_placeholder'),
                this.$container.insertBefore(n, this._els.dhx_cal_header[0])),
        ...
        (g.get_elements = function() {
          for (
            ...
            'string' != typeof n &&
              ...
              !t[e].innerHTML &&
              (n = a.split('_')[0]),
              n && (this._waiAria.labelAttr(t[e], n), (t[e].innerHTML = n));
          }
        }),
        ...
        (g._click = {
          dhx_cal_data: function(t) {
            ...
            if (i && g.config.select) {
              ...
              -1 != a.indexOf('_icon') &&
                g._click.buttons[a.split(' ')[1].replace('icon_', '')](i);
            } else
              g._close_not_saved(),
        ...
        (g.addEventNow = function(t, e, i) {
          ...
          t ||
            (t =
              a.start_date || Math.round(g._currentDate().valueOf() / n) * n);
          var r = new Date(t);
          if (!e) {
        ...
        (g._get_column_index = function(t) {
          ...
          if (this._cols) {
            for (
              var i = 0, a = 0;
              i + this._cols[a] < t && a < this._cols.length;

            )
              (i += this._cols[a]), a++;
            if (
              ((e = a + (this._cols[a] ? (t - i) / this._cols[a] : 0)),
        ...
        (g._mouse_coords = function(t) {
          ...
          (e.y -=
            this.$domHelpers.getAbsoluteTop(n) -
        ...
        (g._is_pos_changed = function(t, e) {
          ...
          return !!(
            ...
            i(t.ev.clientX, e.ev.clientX, a) ||
            i(t.ev.clientY, e.ev.clientY, a)
          );
        }),
        ...
        (g._correct_drag_end_date = function(t, e) {
          ...
          return new Date(
            1 * a - (g._get_fictional_event_length(a, -1, i, -1) + 1)
          );
        }),
          ...
          if (this._drag_mode) {
            ...
            if (this._is_pos_changed(this._drag_pos, e)) {
              ...
              if (
                (this._drag_pos &&
                  !this._drag_pos.has_moved &&
                  ((n = this._drag_pos), (n.has_moved = !0)),
                (this._drag_pos = e),
                ...
                if (
                  ...
                  if ('month' == this._mode)
                    if (
                      ...
                      var h = 864e5;
                      _ <= g.date.date_part(new Date(a + h - 1)).valueOf() &&
                        (i = _ - h);
                    } else a = _;
                  else
                    this.config.preserve_length
                      ? e.resize_from_start
                        ...
                        : (a = g._correct_drag_end_date(_, 0))
                      : e.resize_from_start
                      ? (i = _)
                      : (a = _);
                } else {
              ...
              if (
                ...
                (+E < +g._min_date || +a > +g._max_date)
              ) {
                if (+l.start_date < +g._min_date || +l.end_date > +g._max_date)
                  (E = new Date(l.start_date)), (a = new Date(l.end_date));
                else {
                  var A = a - E;
                  +E < +g._min_date
                    ...
                    : ((a = new Date(g._max_date)),
                      ...
                      this._table_view
                        ? (o._end_correction &&
                            (a = new Date(a.valueOf() - o._end_correction)),
                          (a = new Date(
                            1 * a -
                              this._get_fictional_event_length(a, 0, o, !0)
                          )),
                          (E = new Date(
                            1 * a -
                              this._get_fictional_event_length(
                          ...
                          this._ignores_detected &&
                            ...
                            (a = g.date.add(a, o.x_step, o.x_unit))))
                        : (E = new Date(+a - A)));
                }
                var D = new Date(a - 1);
              }
              ...
              if (
                ...
                (a = g.date.date_part(new Date(h))),
                  a.setHours(this.config.last_hour),
                  (D = new Date(a - 1)),
                  'move' == this._drag_mode && (E = new Date(+a - A));
              }
              if (
                this._table_view ||
                (D.getDate() == E.getDate() &&
          ...
          if (2 != t.button && !this.config.readonly && !this._drag_mode) {
            ...
            if (this._drag_mode) {
              ...
              if (
                ...
                this.callEvent('onBeforeDrag', [a, this._drag_mode, t])
              ) {
                if (
                  ((this._drag_id = a),
            ...
            if (this._drag_mode && this._drag_id) {
              ...
              if (
                ...
                (this._drag_event._dhx_changed ||
                  ...
                  n.end_date.valueOf() != this._drag_event.end_date.valueOf())
              ) {
                ...
                if (
                  ...
                  r
                    ? this.deleteEvent(n.id, !0)
                    : ((this._drag_event._dhx_changed = !1),
                      this._clear_temporary_properties(n, this._drag_event),
                      g._lame_copy(n, this._drag_event),
        ...
        (g.updateView = function(t, e) {
          ...
          var i = 'dhx_cal_data',
            ...
            r = 'dhx_scheduler_' + e;
          this._mode && -1 != a.className.indexOf(n)
            ? (a.className = a.className.replace(n, r))
            : (a.className += ' ' + r);
          var s,
            o = 'dhx_multi_day',
            d =
        ...
        (g._render_x_header = function(t, e, i, a, n) {
          ...
          'month' == this._mode &&
            ...
            this.set_xy(r, s, this.xy.scale_height - 2, e, n);
            ...
            this._ignores[o]
              ...
              (this._colsS[o] =
                ...
                (this._colsS[o - 1] ||
                  (this._table_view
                    ? 0
                    : (a ? this.xy.scroll_width : this.xy.scale_width) + 2)));
        ...
        (g._set_scale_col_size = function(t, e, i) {
          ...
          this.set_xy(
            t,
            e - 1,
            a.hour_size_px * (a.last_hour - a.first_hour),
        ...
        (g._reset_scale = function() {
          if (this.templates[this._mode + '_date']) {
            ...
            var n,
              ...
              o = g._get_view_end();
            (n = r = this._table_view ? g.date.week_start(s) : s),
              (this._min_date = n);
        ...
        (g._reset_hours_scale = function(t, e, i) {
          ...
          for (
            var n = new Date(1980, 1, 1, this.config.first_hour, 0, 0),
        ...
        (g._render_month_scale = function(t, e, i, a) {
          ...
          for (var f = [], l = 0; l < a; l++) {
            ...
            u.appendChild(v);
            for (
              var m = Math.max(n(l) - g.xy.month_head_height, 0), p = 0;
              p < 7;
              p++
            ) {
        ...
        (g._lame_clone = function(t, e) {
          ...
          if (t && 'object' == typeof t) {
            for (
              n = Object.create(t),
                a = [Array, Date, Number, String, Boolean],
                i = 0;
              i < a.length;
              i++
            )
              t instanceof a[i] && (n = i ? new a[i](t) : new a[i]());
            e.push(t, n);
            for (i in t)
              Object.prototype.hasOwnProperty.apply(t, [i]) &&
                (n[i] = g._lame_clone(t[i], e));
          }
          return n || t;
        }),
        ...
        (g._get_real_event_length = function(t, e, i) {
          ...
          i.render
            ? ((o = this._get_date_index(i, t)),
              (a = this._get_date_index(i, e)))
            : (a = Math.round(n / 60 / 60 / 1e3 / 24));
          for (var d = !0; o < a; ) {
        ...
        (g._get_fictional_event_length = function(t, e, i, a) {
          ...
          if (i._start_correction || i._end_correction) {
            var s;
            s = a
              ? 60 * n.getHours() + n.getMinutes() - 60 * (i.first_hour || 0)
              : 60 * (i.last_hour || 0) - (60 * n.getHours() + n.getMinutes());
          ...
          g._waiAria = {
            ...
            weekAgendaDayCell: function(t, e) {
              var i = t.querySelector('.dhx_wa_scale_bar'),
                ...
                n = g.uid() + '';
              this.setAttributes(i, { id: n }),
                this.setAttributes(a, { 'aria-labelledby': n });
            },
            ...
            if (e && 'object' == typeof e)
              switch (!0) {
                case h(e):
                  ...
                  break;
                case o(e):
                  for (a = new Array(e.length), i = 0; i < e.length; i++)
                    a[i] = t(e[i]);
                  break;
                case d(e):
                  a = new String(e);
              ...
              (a &&
                (d.onreadystatechange = function() {
                  if (4 == d.readyState || (l && 3 == d.readyState)) {
                    ...
                    window.setTimeout(function() {
                      'function' == typeof n &&
                        n.apply(window, [{ xmlDoc: d, filePath: e }]),
                        r &&
                          (void 0 !== r.postData
                            ? this.postLong(r.url, r.postData, n)
                            : this.getLong(r.url, n)),
                        (n = null),
                        (d = null);
                    }, 1);
                  }
      ...
      var E = function(t, e) {
        for (
          ...
          switch (a[n]) {
            ...
            case '%M':
              i +=
                'set[1]=this.locale.date.month_short_hash[temp[' + n + ']]||0;';
              break;
            case '%F':
              i +=
                'set[1]=this.locale.date.month_full_hash[temp[' + n + ']]||0;';
          }
      ...
      (g.date = {
        ...
        (function() {
          for (
            ...
            (g['getEvent' + t[a + 1]] = e(t[a])),
              (g['setEvent' + t[a + 1]] = i(t[a]));
        })(),
        ...
        (g.is_visible_events = function(t) {
          ...
          if (
            ...
            return (
              !(!this._table_view && (i > a || i < n) && (e >= a || e < n)) ||
              !!(
        ...
        (g.render_view_data = function(t, e) {
          ...
          for (var a = 0, n = t.length; a < n; a++)
            this._recalculate_timed(t[a]);
          if (this.config.multi_day && !this._table_view) {
            for (var r = [], s = [], a = 0; a < t.length; a++)
              this._is_main_area_event(t[a]) ? r.push(t[a]) : s.push(t[a]);
          ...
          for (var i = {}, a = 0; a < t.length; a++)
            if (this._table_view)
              if ('month' != g._mode) this.render_event_bar(t[a]);
                ...
                n !== 1 * n || t[a]._sorder < n
                  ? this.render_event_bar(t[a])
                  : void 0 !== n &&
                    t[a]._sorder == n &&
                    g._render_month_link(t[a]);
              }
            else {
              var r = t[a],
              ...
              if (s.rows) {
                for (var o = 0; o < s.rows.length; o++) {
                  ...
                  if (n[o] * i > l) {
                    ...
                    n[o] <= this.config.max_month_events
                      ? (_ = n[o] * i)
                  ...
                  n[o] =
                    (n[o - 1] || 0) + g._get_first_visible_cell(d).offsetHeight;
                }
                if (
                  (n.unshift(0),
                ...
                (x.style.height = p),
                  (x.style.visibility = -1 == n[0] ? 'hidden' : 'visible');
        ...
        (g._pre_render_events_line = function(t, e) {
          ...
          if (!e) {
            for (var n = 0; n < t.length; n++)
              t[n]._count = i[t[n]._sday].max_count;
            for (var n = 0; n < a.length; n++)
              a[n]._count = i[a[n]._sday].max_count;
          }
          return t;
        }),
        ...
        (g._render_v_bar = function(t, e, i, a, n, r, s, o, d) {
          ...
          var f = t.color ? 'background-color:' + t.color + ';' : '',
            ...
            w = m ? p - 2 : a - 8,
            D = m
              ? n - this.xy.event_header_height - 1
              : n - (this._quirks ? 20 : 30) + 1,
            E =
              '<div event_id="' +
              _ +
              '" class="' +
        ...
        (g._get_event_bar_pos = function(t) {
          var e = this.config.rtl,
            ...
            n = i[t._eday];
          e &&
            ((a = i[i.col_length] - i[t._eday] + i[0]),
            (n = i[i.col_length] - i[t._sday] + i[0])),
            n == a && (n = i[t._eday + 1]);
        ...
        (g.getEvents = function(t, e) {
          ...
          for (var a in this._events) {
            ...
            n &&
              ((!t && !e) || (n.start_date < e && n.end_date > t)) &&
              i.push(n);
          }
          return i;
        }),
        ...
        (g.showEvent = function(t, e) {
          ...
          t &&
            'object' == typeof t &&
            ((e = t.mode), (i = t.section), (t = t.section));
          var a =
        ...
        (g._append_drag_marker = function(t) {
          if (!t.parentNode) {
            var e = g._els.dhx_cal_data[0],
              i = e.lastChild,
              a = g._getClassName(i);
            a.indexOf('dhx_scale_holder') < 0 &&
              i.previousSibling &&
              (i = i.previousSibling),
              (a = g._getClassName(i)),
              i && 0 === a.indexOf('dhx_scale_holder') && i.appendChild(t);
          }
        }),
        ...
        (g._load = function(t, e) {
          ...
          if ((t = t || this._load_url)) {
            ...
            if (((e = e || this._date), this._load_mode)) {
              ...
              if (a <= e) return !1;
              for (g.$ajax.get(t + '&from=' + n(e) + '&to=' + n(a), i); e < a; )
                (this._loaded[n(e)] = !0),
                  (e = this.date.add(e, 1, this._load_mode));
            } else g.$ajax.get(t, i);
            return (
        ...
        (g._parsers.xml = {
          ...
          parse: function(t) {
            ...
            i &&
              ...
              (g.security_key = i));
            for (
              var a = g.$ajax.xpath('//coll_options', t.xmlDoc), n = 0;
              n < a.length;
              n++
            ) {
              ...
              for (
                var o = g.$ajax.xpath('.//item', a[n]), d = 0;
                d < o.length;
                d++
              ) {
                for (
            ...
            for (
              var f = g.$ajax.xpath('//userdata', t.xmlDoc), n = 0;
              n < f.length;
              n++
            ) {
          ...
          parse_param: function(t, e) {
            ...
            if (-1 != i) {
              ...
              'summary' == a
                ? (a = 'text')
                : 'dtstart' == a
                ? ((a = 'start_date'), (n = this.parse_date(n, 0, 0)))
                : 'dtend' == a &&
                  ((a = 'end_date'), (n = this.parse_date(n, 0, 0))),
                (e[a] = n);
            }
          },
        ...
        (g._xmlNodeToJSON = function(t) {
          ...
          for (var i = 0; i < t.childNodes.length; i++) {
            ...
            1 == a.nodeType &&
              (e[a.tagName] = a.firstChild ? a.firstChild.nodeValue : '');
          }
          return (
        ...
        (g.form_blocks = {
          ...
          select: {
            ...
            set_value: function(t, e, i, a) {
              ...
              !n._dhx_onchange &&
                a.onchange &&
                ((n.onchange = a.onchange), (n._dhx_onchange = !0)),
                void 0 === e && (e = (n.options[0] || {}).value),
                (n.value = e || '');
            },
            get_value: function(t, e) {
                  ...
                  case '%H:%i':
                    ...
                    for (t._time_values = []; v < n; ) {
                      (_ +=
                        ...
                        v +
                        "'>" +
                        this.templates.time_picker(a) +
                        '</option>'),
                        t._time_values.push(v),
                        a.setTime(
                          a.valueOf() + 60 * this.config.time_step * 1e3
                        );
                      v =
                        24 * (a.getDate() != m ? 1 : 0) * 60 +
                        60 * a.getHours() +
                        a.getMinutes();
                    }
                }
        ...
        (g._setLbPosition = function(t) {
          if (t) {
            ...
            (t.style.top = e
              ...
              : Math.round(Math.max((a - t.offsetHeight) / 2, 0) + 9) + 'px'),
                  ...
                  default:
                    if (e.getAttribute('dhx_button'))
                      ...
                      -1 != i.indexOf('dhx_custom_button') &&
                        ...
                        n &&
                          ((r =
                            g.form_blocks[g.config.lightbox.sections[n].type]),
                          r.button_click(n, e, s, s.nextSibling));
                    }
                }
            }
          }),
          ...
          if (!this._lightbox) {
            ...
            for (var n = 0; n < s.length; n++) {
              ...
              if (o) {
                ...
                var d = '';
                if (s[n].button) {
                  var a = g._waiAria.lightboxSectionButtonAttrString(
                    this.locale.labels['button_' + s[n].button]
                  );
                  d =
                    '<div ' +
                    a +
                ...
                'string' != typeof l && (l = s[n].name),
                  (e +=
                    ...
                    l +
                    '</label></div>' +
                    o.render.call(this, s[n])),
                  (e += '</div>');
              }
            }
            for (
              var _ = t.getElementsByTagName('div'), n = 0;
              n < _.length;
              n++
            ) {
              var h = _[n];
                  ...
                  (g.render_view_data = function() {
                    for (
                      var t = g.getState().drag_id,
                        e = g.getEvent(t),
                        i = a.y_property,
                        n = g.getEvents(e.start_date, e.end_date),
                        r = 0;
                      r < n.length;
                      r++
                    )
                      n[r][i] != e[i] && (n.splice(r, 1), r--);
                    (e._sorder = n.length - 1),
                      (e._count = n.length),
            ...
            if (g._drag_id && !t) {
              ...
              a &&
                (i =
                  '<div>' +
                  (a._timed
                    ? g.templates.event_header(a.start_date, a.end_date, a)
                    : g.templates.day_date(a.start_date, a.end_date, a)) +
                  '</div>');
            }
        ...
        (g._dp_init = function(t) {
          ...
          var e = function(t, i, a) {
              ...
              for (var n in t)
                0 !== n.indexOf('_') &&
                  (t[n] && t[n].getUTCFullYear
                    ? (i[a + n] = this.obj._helpers.formatDate(t[n]))
                    : t[n] && 'object' == typeof t[n]
                    ? e.call(this, t[n], i, a + n + '.')
                    : (i[a + n] = t[n]));
              return i;
            },
            i = function(t) {
              ...
              for (var a in e)
                0 === a.indexOf('_')
                  ...
                  : e[a] &&
                    (e[a].getUTCFullYear
                      ? (e[a] = this.obj._helpers.formatDate(e[a]))
                      : 'object' == typeof e[a] && (e[a] = i(e[a])));
              return e;
            };
      ...
      window.addEventListener('DOMContentLoaded', f),
        ...
        (g._skin_init = function() {
          ...
          if (
            ...
            if (
              n &&
              g.config.buttons_left.slice().join() == n &&
              r &&
                  ...
                  ((g.templates.month_day = function(i) {
                    if ('month' == this._mode) {
                      ...
                      return (
                        1 == i.getDate() &&
                          (a =
                            g.locale.date.month_full[i.getMonth()] + ' ' + a),
                        +i == +g.date.date_part(this._currentDate()) &&
                          (a = g.locale.labels.dhx_cal_today_button + ' ' + a),
                        a
                      );
                    }
        ...
        window.jQuery &&
          (function(t) {
            ...
            t.fn.dhx_scheduler = function(a) {
              ...
              t.error(
                'Method ' + a + ' does not exist on jQuery.dhx_scheduler'
              );
            };
          })(jQuery),
        (function() {
  ...
  var _0xaedc = [
    ...
    'indexOf',
    'error',
    'This version of dhtmlxScheduler is not intended for using outside of dhtmlx.com',
    'message',
    'random',
    'floor'
  ];
